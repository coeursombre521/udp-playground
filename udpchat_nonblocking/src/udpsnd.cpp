...
void
UdpSend::add_to_queue(const std::string &msg)
{
    this->m_send_queue.push(msg);
}

void
UdpSend::send_all_from_queue()
{
    while (!this->m_send_queue.empty()) {
        this->send(this->m_send_queue.front());
